...
export default function FriendFamily(){
    return (
      <>
      <Layout>
            <div className="container-fluid py-5" id="family">
                <div className="container pt-5 pb-3">
                    <div className="section-title position-relative text-center">
                        <h6 className="text-uppercase text-primary mb-3" style={{"letter-spacing": "3px"}}>Friends & Family</h6>
                            ...
                            <div className="position-relative mb-2">
                                ...
                                <div className="bg-secondary text-center p-4">
                                    ...
                                    <div className="d-inline-block">
                                        <a className="mx-2" href="https://www.google.com"><i className="fab fa-twitter"></i></a>
                                        <a className="mx-2" href="https://www.google.com"><i className="fab fa-facebook-f"></i></a>
                                        <a className="mx-2" href="https://www.google.com"><i className="fab fa-linkedin-in"></i></a>
                                        <a className="mx-2" href="https://www.google.com"><i className="fab fa-instagram"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
